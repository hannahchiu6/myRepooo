...
func displayMyAlertMessage(userMessage: String){
  ...
  @IBAction func actionButton(_ sender: Any) {
    ...
    if(userPW == "1234" && userID == "appworks_school@gmal.com" && currentPageType == PageType.login){
    ...
    if((userPW != "1234" || userID != "appworks_school@gmal.com" || checkPW != "1234") && currentPageType == PageType.signup ){
        displayMyAlertMessage(userMessage: "Signup failed.")
    }
 
    if(userPW == checkPW && userID == "appworks_school@gmal.com" && currentPageType == PageType.signup){
        displayMyAlertMessage(userMessage: "Signup successful.")
